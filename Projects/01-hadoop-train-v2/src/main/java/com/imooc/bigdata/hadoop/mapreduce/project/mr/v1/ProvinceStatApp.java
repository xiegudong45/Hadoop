package com.imooc.bigdata.hadoop.mapreduce.project.mr.v1;
...
public class ProvinceStatApp {
  ...
  public static void main(String[] args) throws Exception{
    ...
    // Path outputPath = new Path("output/v1/prostat");
    ...
    //         ".data"));
    // FileOutputFormat.setOutputPath(job, new Path("output/v1/prostat"));
